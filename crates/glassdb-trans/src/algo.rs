...
mod tests {
    ...
    use super::direct_commit::{DirectCommitResolver, Ineligible, eligible_writer};
    use super::*;
    ...
    async fn direct_commit_blocked_after_uncertain_cas_stays_in_doubt() {
        ...
        let resolver = DirectCommitResolver {
            ...
            split_hints: tm.direct_commit.split_hints_for_test(),
        };
    ...
    async fn direct_commit_replays_only_a_certified_superseded_read() {
        ...
        let split_hints = tm.direct_commit.split_hints_for_test();
