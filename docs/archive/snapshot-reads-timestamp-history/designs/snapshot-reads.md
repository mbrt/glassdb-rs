...
> **Archived — discarded.** This timestamp-versioned design and its proposed
> ADRs were never accepted or implemented. It is preserved with its
> [review](snapshot-reads-review.md) for design history. The active proposal is
> the [dependency-checkpoint design](../../../designs/snapshot-reads.md).

## Status

**Discarded.** This design proposed long-lived, internally consistent, read-only
